        ...
        <div class="card job-list-view-card overflow-hidden" id="job-overview">
            ...
            <div class="card-body">
                ...
                <div class="mt-4">
                    ...
                    <div>
                        <div id="simple_dount_chart" data-colors='["--vz-secondary", "--vz-success", "--vz-danger"]' class="apex-charts" dir="ltr"></div>
                    </div>
                </div>
                <div class="mt-4">
                    <button type="button" class="btn btn-soft-primary w-100">Apply Now</button>
                </div>
            </div>
        </div>
    </div>
