...
<div class="profile-foreground position-relative mx-n4 mt-n4">
    ...
    <div class="pt-4 mb-4 mb-lg-3 pb-lg-4 profile-wrapper">
        <div class="row g-4">
            <div class="col-auto">
                <div class="avatar-lg">
                    <img src="@if (Auth::user()->avatar != '') {{ URL::asset('images/' . Auth::user()->avatar) }}@else{{ URL::asset('build/images/users/avatar-1.jpg') }} @endif" alt="user-img"
            ...
            <div>
                <div class="d-flex profile-wrapper">
                    ...
                    <div class="flex-shrink-0">
                        <a href="{{ URL::asset('/pages-profile-settings') }}" class="btn btn-info"><i
