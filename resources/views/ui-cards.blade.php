...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-6 col-xl-3">
            <!-- Simple card -->
            <div class="card">
                <img class="card-img-top img-fluid" src="{{ URL::asset('build/images/small/img-1.jpg') }}"
                    alt="Card image cap">
                <div class="card-body">
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card">
                <img class="card-img-top img-fluid" src="{{ URL::asset('build/images/small/img-2.jpg') }}"
                    alt="Card image cap">
                <div class="card-body">
            ...
            <div class="row">
                <div class="col-xxl-4 col-lg-6">
                    <div class="card card-body">
                        ...
                        <a href="javascript:void(0);" class="btn btn-info">Apply Now</a>
                    </div>
                </div><!-- end col -->
                <div class="col-xxl-4 col-lg-6">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="row">
                <div class="col-xxl-4 col-lg-6">
                    <div class="card card-overlay">
                        <img class="card-img img-fluid" src="{{ URL::asset('build/images/small/img-12.jpg') }}"
                            alt="Card image">
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card card-overlay">
                        <img class="card-img img-fluid" src="{{ URL::asset('build/images/small/img-1.jpg') }}"
                            alt="Card image">
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card card-overlay">
                        <img class="card-img img-fluid" src="{{ URL::asset('build/images/small/img-5.jpg') }}"
                            alt="Card image">
            ...
            <div class="row">
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        <img class="card-img-top img-fluid" src="{{ URL::asset('build/images/small/img-6.jpg') }}"
                            alt="Card image cap">
                        <div class="card-body">
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        ...
                        <img class="card-img-bottom img-fluid" src="{{ URL::asset('build/images/small/img-7.jpg') }}"
                            alt="Card image cap">
                    </div>
                </div><!-- end col -->
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        ...
                        <img class="card-img rounded-0 img-fluid"
                            src="{{ URL::asset('build/images/small/img-8.jpg') }}" alt="Card image cap">
                        <div class="card-footer">
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        ...
                        <img class="card-img rounded-0 img-fluid"
                            src="{{ URL::asset('build/images/small/img-10.jpg') }}" alt="Card image cap">
                        <div class="card-footer">
                            <p class="card-text mb-0">
                                Last updated 3 mins ago
                            </p>
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        <img class="card-img-top img-fluid" src="{{ URL::asset('build/images/small/img-11.jpg') }}"
                            alt="Card image cap">
                        <div class="card-header">
                            <h4 class="card-title mb-0">A day in the of a professional fashion designer</h4>
                        </div>
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        ...
                        <img class="card-img-bottom img-fluid" src="{{ URL::asset('build/images/small/img-11.jpg') }}"
                            alt="Card image cap">
                    </div>
                </div><!-- end col -->
            </div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card-group">
                ...
                <div class="card mb-4">
                    <img class="card-img-top img-fluid" src="{{ URL::asset('build/images/small/img-5.jpg') }}"
                        alt="Card image cap" />
                    <div class="card-body">
    ...
    <div class="row g-3">
        ...
        <div class="col-xxl col-6">
            <div class="card h-100">
                ...
                <img class="img-fluid" src="{{ URL::asset('build/images/small/img-11.jpg') }}"
                    alt="Card image cap" />
                <div class="card-body">
        ...
        <div class="col-xxl col-6">
            <div class="card h-100">
                <img class="card-img-top img-fluid" src="{{ URL::asset('build/images/small/img-10.jpg') }}"
                    alt="Card image cap" />
                <div class="card-body">
                    <h4 class="card-title">Give your text a good structure?</h4>
                    <p class="card-text">This is a wider card with supporting text below as
