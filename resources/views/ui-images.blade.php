                        ...
                        <div class="row align-items-center">
                            <div class="col-6">
                                <img class="rounded" alt="200x200" width="200"
                                    src="{{ URL::asset('build/images/small/img-4.jpg') }}" data-holder-rendered="true">
                            </div><!-- end col -->
                            <div class="col-6">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <img class="img-thumbnail" alt="200x200" width="200"
                                    src="{{ URL::asset('build/images/small/img-3.jpg') }}" data-holder-rendered="true">
                            </div><!-- end col -->
                            <div class="col-6">
                                <div class="mt-4 mt-md-0">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        ...
                        <div>
                            <img src="{{ URL::asset('build/images/small/img-2.jpg') }}" class="img-fluid"
