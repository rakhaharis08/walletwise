...
<div class="row">
    <div class="col-xl-6">
        <div class="card">
            ...
            <div class="card-body">
                <div id="area_chart_basic" data-colors='["--vz-info"]' class="apex-charts" dir="ltr"></div>
            </div><!-- end card-body -->
        </div><!-- end card -->
    </div>
    <!-- end col -->
...
<div class="row">
            ...
            <div class="card-body">
                <div>
                    <div class="toolbar d-flex align-items-start justify-content-center flex-wrap gap-2">
                        ...
                        <button type="button" class="btn btn-soft-info timeline-btn btn-sm active" id="one_year">
                            1Y
                        </button>
    ...
    <div class="col-xl-6">
        <div class="card">
            ...
            <div class="card-body">
                <div id="area_chart_negative" data-colors='["--vz-primary", "--vz-info"]' class="apex-charts" dir="ltr"></div>
            </div><!-- end card-body -->
        </div><!-- end card -->
    </div>
    <!-- end col -->
...
<div class="row">
    <div class="col-xl-6">
        <div class="card">
            ...
            <div class="card-body">
                <div>
                    <div class="bg-light">
                        <div id="area_chart-months" data-colors='["--vz-info"]' class="apex-charts" dir="ltr"></div>
                    </div>
    ...
    <div class="col-xl-6">
        <div class="card">
            ...
            <div class="card-body">
                <div id="area_chart_stacked" data-colors='["--vz-primary", "--vz-info", "--vz-gray-300"]' class="apex-charts" dir="ltr"></div>
            </div><!-- end card-body -->
        </div><!-- end card -->
    </div>
    <!-- end col -->
...
<div class="row">
    <div class="col-xl-6">
        <div class="card">
            ...
            <div class="card-body">
                <div id="area_chart_irregular" data-colors='["--vz-primary", "--vz-info", "--vz-gray-300"]' class="apex-charts" dir="ltr"></div>
            </div><!-- end card-body -->
        </div><!-- end card -->
    </div>
    <!-- end col -->
