                                    ...
                                    <div class="col-xl-4 col-lg-10">
                                        <div class="row g-2">
                                            <div class="col-md-3 col-sm-6">
                                                <div>
                                                    <a href="{{ URL::asset('build/images/small/img-1.jpg') }}"
                                            ...
                                            <div class="col-md-3 col-sm-6">
                                                <div>
                                                    <a href="{{ URL::asset('build/images/small/img-3.jpg') }}"
                                                        class="image-popup d-block">
                                            ...
                                            <div class="col-md-3 col-sm-6">
                                                <div>
                                                    <a href="{{ URL::asset('build/images/small/img-4.jpg') }}"
                                                        class="image-popup d-block">
                                    ...
                                    <div class="swiper images-menu mb-3">
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="{{ URL::asset('build/images/small/img-8.jpg') }}"
                                                            alt="" width="65" class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                                        <a href="javascript:void(0);"
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup"
                                                    href="{{ URL::asset('build/images/small/img-1.jpg') }}" title="">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup"
                                                    href="{{ URL::asset('build/images/small/img-2.jpg') }}" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup"
                                                    href="{{ URL::asset('build/images/small/img-3.jpg') }}" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup"
                                                    href="{{ URL::asset('build/images/small/img-4.jpg') }}" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup"
                                                    href="{{ URL::asset('build/images/small/img-5.jpg') }}" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup"
                                                    href="{{ URL::asset('build/images/small/img-6.jpg') }}" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup"
                                                    href="{{ URL::asset('build/images/small/img-7.jpg') }}" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup"
                                                    href="{{ URL::asset('build/images/small/img-8.jpg') }}" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup"
                                                    href="{{ URL::asset('build/images/small/img-9.jpg') }}" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup"
                                                    href="{{ URL::asset('build/images/small/img-10.jpg') }}" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                                        src="{{ URL::asset('build/images/small/img-10.jpg') }}"
                                                        alt="" />
                                                    <div class="gallery-overlay">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup"
                                                    href="{{ URL::asset('build/images/small/img-11.jpg') }}" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                                        src="{{ URL::asset('build/images/small/img-11.jpg') }}"
                                                        alt="" />
                                                    <div class="gallery-overlay">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup"
                                                    href="{{ URL::asset('build/images/small/img-12.jpg') }}" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                                        src="{{ URL::asset('build/images/small/img-12.jpg') }}"
                                                        alt="" />
                                                    <div class="gallery-overlay">
