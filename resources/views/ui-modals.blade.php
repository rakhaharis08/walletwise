                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <p class="text-muted">The bedding was hardly able to cover it and seemed
                                                ...
                                                the size of the rest of him, waved about helplessly as he looked. "What's
...
&lt;/div&gt;&lt;!-- /.modal --&gt;</code></pre>
        ...
        <div class="col-xxl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>modal-dialog-centered</code> class to show vertically center the
                        modal.</p>
                    <div class="live-preview">
                        <div>
                            <!-- center modal -->
...
&lt;/div&gt;</code></pre>
        ...
        <div class="col-xxl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>data-bs-backdrop="static"</code> to modal not to close when
                        clicking outside the modal.</p>
                    <div class="live-preview">
                        <div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <p class="text-muted">You only need to know a little to make a big <a href="#"
                                        ...
                                        <p class="text-muted">Opposites attract, and that’s a fact. It’s in our <a
                                                ...
                                                design</a> to be interested in the unusual, and that’s why using <a href="#"
                                                class="tooltip-test text-decoration-underline" title="Web Developers"
        ...
        <div class="col-xxl-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted">Use<code> modal-dialog-scrollable</code> class to create a modal scrollable.
                    </p>
        ...
        <div class="col-xxl-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted">Use <code>event.relatedTarget</code> and HTML <code>data-bs-*</code>
                        attributes to vary the contents of the modal depending on which button was clicked.</p>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>modal-fullscreen</code>, <code>modal-xl</code>,
                        <code>modal-lg</code>, or <code>modal-sm</code> class to modal-dialog class to set different size
                        modal respectively.</p>
                    <div class="live-preview">
                        <div>
                        ...
                        <div>
                            ...
                            <div class="modal fade" id="fullscreeexampleModal" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-fullscreen">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="fullscreeexampleModalLabel">Full screen modal
                                            </h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted text-muted">Use <code>modal-dialog-right</code>, <code>modal-dialog-bottom</code>,
                        or <code>modal-dialog-bottom-right</code> class to modal-dialog class to set modal at different
