...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row g-4 mb-3">
        <div class="col-sm-auto">
            <div>
                <a href="<?php echo e(URL::asset('/apps-projects-create')); ?>" class="btn btn-success"><i
                ...
                <div class="card-body">
                    <div class="d-flex flex-column h-100">
                        ...
                        <div class="d-flex mb-2">
                            ...
                            <div class="flex-grow-1">
                                <h5 class="mb-1 fs-16"><a href="<?php echo e(URL::asset('/apps-projects-overview')); ?>"
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a class="dropdown-item"
                                                href="<?php echo e(URL::asset('/apps-projects-overview')); ?>"><i
                                                    class="ri-eye-fill align-bottom me-2 text-muted"></i>
                                                View</a>
                                            <a class="dropdown-item" href="<?php echo e(URL::asset('/apps-projects-create')); ?>"><i
                                                    class="ri-pencil-fill align-bottom me-2 text-muted"></i>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="p-3 mt-n3 mx-n3 bg-soft-danger rounded-top">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                <h5 class="mb-0 fs-15"><a href="<?php echo e(URL::asset('/apps-projects-overview')); ?>"
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div>
                        ...
                        <div class="progress progress-sm animated-progress">
                            <div class="progress-bar bg-info" role="progressbar" aria-valuenow="41" aria-valuemin="0"
        ...
        <div class="col-xxl-3 col-sm-6 project-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="py-3">
                        <h5 class="fs-15 mb-3"><a href="<?php echo e(URL::asset('/apps-projects-overview')); ?>"
                                class="text-dark">Kanban
                                Board</a></h5>
                        <div class="row gy-3">
                            <div class="col-6">
                                <div>
        ...
        <div class="col-xxl-3 col-sm-6 project-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="py-3">
                        <h5 class="mb-3 fs-15"><a href="<?php echo e(URL::asset('/apps-projects-overview')); ?>"
                                class="text-dark">Ecommerce
                                app</a></h5>
                        <div class="row gy-3">
                            <div class="col-6">
                                <div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\Laravel\interactive\resources\views/apps-projects-list.blade.php ENDPATH**/ ?>