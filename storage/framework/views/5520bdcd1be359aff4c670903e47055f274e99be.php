...
<div class="row">
    ...
    <div class="col-xl-6">
        <div class="card">
            ...
            <div class="card-body">
                <div id="multiple_radialbar" data-colors='["--vz-primary", "--vz-info", "--vz-warning", "--vz-danger"]' class="apex-charts" dir="ltr"></div>
            </div><!-- end card-body -->
        </div><!-- end card -->
    </div>
    <!-- end col -->
...
<div class="row">
    ...
    <div class="col-xl-6">
        <div class="card">
            ...
            <div class="card-body">
                <div id="gradient_radialbar" data-colors='["--vz-info"]' class="apex-charts" dir="ltr"></div>
            </div><!-- end card-body -->
        </div><!-- end card -->
    </div>
    <!-- end col -->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\velzon_Laravel\interactive\resources\views/charts-apex-radialbar.blade.php ENDPATH**/ ?>