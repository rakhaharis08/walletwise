                            ...
                            <div class="row g-2">
                                <div class="col">
                                    <div class="position-relative mb-3">
                                        ...
                                        <a class="btn btn-link link-info btn-lg position-absolute end-0 top-0"
                    ...
                    <div class="tab-content text-muted">
                        <div class="tab-pane active" id="all" role="tabpanel">
                            <div class="pb-3">
                                ...
                                <p class="text-info mb-2">https://themesbrand.com/velzon/index.html</p>
                                    ...
                                    <div class="col-xl-4 col-lg-10">
                                        <div class="row g-2">
                                            <div class="col-md-3 col-sm-6">
                                                <div>
                                                    <a href="<?php echo e(URL::asset('assets/images/small/img-1.jpg')); ?>"
                                            ...
                                            <div class="col-md-3 col-sm-6">
                                                <div>
                                                    <a href="<?php echo e(URL::asset('assets/images/small/img-3.jpg')); ?>"
                                                        class="image-popup d-block">
                                            ...
                                            <div class="col-md-3 col-sm-6">
                                                <div>
                                                    <a href="<?php echo e(URL::asset('assets/images/small/img-4.jpg')); ?>"
                                                        class="image-popup d-block">
                            ...
                            <div class="py-3">
                                <h5 class="mb-1"><a href="javascript:void(0);">Skote - Admin & Dashboard Template
                                        by Themesbrand</a></h5>
                                <p class="text-info mb-2">https://themesbrand.com/skote/</p>
                            ...
                            <div class="py-3">
                                <h5 class="mb-1"><a href="javascript:void(0);">Minia - React Js Admin & Dashboard
                                        Template</a></h5>
                                <p class="text-info mb-2">https://themesbrand.com/minia/react/</p>
                            ...
                            <div class="py-3">
                                ...
                                <p class="text-info mb-2">https://themesbrand.com/dason/angular/</p>
                                    ...
                                    <div class="swiper images-menu mb-3">
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="<?php echo e(URL::asset('assets/images/small/img-8.jpg')); ?>"
                                                            alt="" width="65" class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                                        <a href="javascript:void(0);"
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup"
                                                    href="<?php echo e(URL::asset('assets/images/small/img-1.jpg')); ?>" title="">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup"
                                                    href="<?php echo e(URL::asset('assets/images/small/img-2.jpg')); ?>" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup"
                                                    href="<?php echo e(URL::asset('assets/images/small/img-3.jpg')); ?>" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup"
                                                    href="<?php echo e(URL::asset('assets/images/small/img-4.jpg')); ?>" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup"
                                                    href="<?php echo e(URL::asset('assets/images/small/img-5.jpg')); ?>" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup"
                                                    href="<?php echo e(URL::asset('assets/images/small/img-6.jpg')); ?>" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup"
                                                    href="<?php echo e(URL::asset('assets/images/small/img-7.jpg')); ?>" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup"
                                                    href="<?php echo e(URL::asset('assets/images/small/img-8.jpg')); ?>" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup"
                                                    href="<?php echo e(URL::asset('assets/images/small/img-9.jpg')); ?>" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup"
                                                    href="<?php echo e(URL::asset('assets/images/small/img-10.jpg')); ?>" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup"
                                                    href="<?php echo e(URL::asset('assets/images/small/img-11.jpg')); ?>" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                                        src="<?php echo e(URL::asset('assets/images/small/img-11.jpg')); ?>"
                                                        alt="" />
                                                    <div class="gallery-overlay">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup"
                                                    href="<?php echo e(URL::asset('assets/images/small/img-12.jpg')); ?>" title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                                        src="<?php echo e(URL::asset('assets/images/small/img-12.jpg')); ?>"
                                                        alt="" />
                                                    <div class="gallery-overlay">
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="<?php echo e(URL::asset('assets/images/small/img-8.jpg')); ?>" alt=""
                                                        width="115" class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                            ...
                            <div class="row">
                                <div class="col-lg-12 video-list">
                                    <div class="list-element">
                                        ...
                                        <p class="text-info">https://themesbrand.com/velzon/index.html</p>
                                ...
                                <div class="text-center">
                                    <button id="loadmore" class="btn btn-link link-info mt-2"><i
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\Laravel\interactive\resources\views/pages-search-results.blade.php ENDPATH**/ ?>