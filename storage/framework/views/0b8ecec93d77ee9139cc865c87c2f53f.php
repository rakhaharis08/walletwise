                    ...
                    <div class="row">
                            ...
                            <div class="verti-sitemap">
                                <ul class="list-unstyled mb-0">
                                    <li class="p-0 parent-title"><a href="javascript: void(0);"
                                            class="fw-semibold fs-14">Nancy Martino - Project
                                            Director</a>
                                    </li>
                                    <li>
                                        <div class="first-list">
                                            <div class="list-wrap">
                                                <a href="javascript: void(0);" class="fw-semibold text-primary">Erica
                                        ...
                                        <div class="first-list">
                                            <div class="list-wrap">
                                                <a href="javascript: void(0);" class="fw-semibold text-primary">Mary
                                                    Jones
                                                    - Project Manager</a>
                                            </div>
                                            <ul class="second-list list-unstyled">
                                        ...
                                        <div class="first-list">
                                            <div class="list-wrap">
                                                <a href="javascript: void(0);" class="fw-semibold text-primary">Tilly
                                                    Kent
                                                    - Executive Manager</a>
                                            </div>
                                            <ul class="second-list list-unstyled">
                                        ...
                                        <div class="first-list">
                                            <div class="list-wrap">
                                                <a href="javascript: void(0);" class="fw-semibold text-primary">Rachel
                                                    Rose
                                                    - HR</a>
                                            </div>
                                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="verti-sitemap">
                                <ul class="list-unstyled mb-0">
                                    <li class="p-0 parent-title"><a href="javascript: void(0);"
                                            class="fw-semibold fs-14">Velzon</a></li>
                                    <li>
                                        <div class="first-list">
                                            <div class="list-wrap">
                                                <a href="javascript: void(0);" class="fw-semibold text-primary"><i
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\Laravel\interactive\resources\views/pages-sitemap.blade.php ENDPATH**/ ?>