                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarLanding">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="nft-landing" class="nav-link"> <?php echo app('translator')->get('translation.nft-landing'); ?> <span class="badge badge-pill bg-danger" ><?php echo app('translator')->get('translation.new'); ?></span></a>
                            </li>
                        </ul>
                    </div>
                </li>
...
<?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\interactive\Admin\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>