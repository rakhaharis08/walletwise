                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="<?php echo e(URL::asset('assets/images/sweetalert2/success-message.png')); ?>"
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="<?php echo e(URL::asset('assets/images/sweetalert2/error-message.png')); ?>"
                                            alt="Mac Image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="<?php echo e(URL::asset('assets/images/sweetalert2/warning-message.png')); ?>"
                                            alt="Mac Image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="<?php echo e(URL::asset('assets/images/sweetalert2/join-community.png')); ?>"
                                            alt="Mac Image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="<?php echo e(URL::asset('assets/images/sweetalert2/email-verify.png')); ?>"
                                            alt="Mac Image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="<?php echo e(URL::asset('assets/images/sweetalert2/notification-message.png')); ?>"
                                            alt="Mac Image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\Laravel\interactive\resources\views/advance-ui-sweetalerts.blade.php ENDPATH**/ ?>