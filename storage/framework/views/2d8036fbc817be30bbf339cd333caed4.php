        ...
        <div class="col-xxl-9">
                ...
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="toolbar d-flex align-items-start justify-content-center flex-wrap gap-2">
                            <button type="button" class="btn btn-soft-info timeline-btn btn-sm" id="one_month">
                                1M
                            </button>
                            <button type="button" class="btn btn-soft-info timeline-btn btn-sm" id="six_months">
                                6M
                            </button>
                            <button type="button" class="btn btn-soft-info timeline-btn btn-sm" id="one_year">
                                1Y
                            </button>
            ...
            <div class="d-flex align-items-center mb-3">
                ...
                <div class="flexshrink-0">
                    <button class="btn btn-info btn-sm"><i class="ri-star-line align-bottom"></i> Add Watchlist</button>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-success fs-14 mb-0">+0.63%<span
                                                class="text-muted ms-2 fs-12">(BTC)</span></p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-danger fs-14 mb-0">-3.42%<span
                                                class="text-muted ms-2 fs-12">(LTC)</span></p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                                        <div class="apex-charts crypto-widget"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-danger fs-14 mb-0">+0.42%<span
                                                class="text-muted ms-2 fs-12">(ETH)</span></p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                                        <div class="apex-charts crypto-widget"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-danger fs-14 mb-0">-1.92%<span
                                                class="text-muted ms-2 fs-12">(XMR)</span></p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                                        <div class="apex-charts crypto-widget"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-success fs-14 mb-0">+16.38%<span
                                                class="text-muted ms-2 fs-12">(DASH)</span></p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                                        <div class="apex-charts crypto-widget"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-success fs-14 mb-0">+0.36%<span
                                                class="text-muted ms-2 fs-12">(MKR)</span></p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                                        <div class="apex-charts crypto-widget"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-success fs-14 mb-0">32.07%<span
                                                class="text-muted ms-2 fs-12">(NEO)</span></p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                                        <div class="apex-charts crypto-widget"
                        ...
                        <table class="table align-middle table-nowrap" id="customerTable">
                            ...
                            <tbody class="list form-check-all">
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-semibold">
                                            ...
                                            <a href="javascript:void(0)" class="currency_name link-dark">Bitcoin (BTC)</a>
                                        </div>
                                    </td>
                                    ...
                                    <td class="returns_per">
                                        <h6 class="text-success fs-14 mb-0"><i
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-semibold">
                                            <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/eth.svg')); ?>" alt=""
                                                class="avatar-xxs me-2" />
                                            <a href="javascript:void(0)" class="currency_name link-dark">Ethereum (ETH)</a>
                                        </div>
                                    </td>
                                    ...
                                    <td class="returns_per">
                                        <h6 class="text-danger fs-14 mb-0"><i
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-semibold">
                                            <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/xrp.svg')); ?>" alt=""
                                                class="avatar-xxs me-2" />
                                            <a href="javascript:void(0)" class="currency_name link-dark">Ripple (XRP)</a>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-semibold">
                                            <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/xmr.svg')); ?>" alt=""
                                                class="avatar-xxs me-2" />
                                            <a href="javascript:void(0)" class="currency_name link-dark">Monero (XMR)</a>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-semibold">
                                            <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/ltc.svg')); ?>" alt=""
                                                class="avatar-xxs me-2" />
                                            <a href="javascript:void(0)" class="currency_name link-dark">Litecoin (LTC)</a>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-semibold">
                                            <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/aave.svg')); ?>" alt=""
                                                class="avatar-xxs me-2" />
                                            <a href="javascript:void(0)" class="currency_name link-dark">Aave (AAVE)</a>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-semibold">
                                            <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/mkr.svg')); ?>" alt=""
                                                class="avatar-xxs me-2" />
                                            <a href="javascript:void(0)" class="currency_name link-dark">Maker (MKR)</a>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-semibold">
                                            <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/yfi.svg')); ?>" alt=""
                                                class="avatar-xxs me-2" />
                                            <a href="javascript:void(0)" class="currency_name link-dark">Yearn.finance
                                                (YFI)</a>
                                        </div>
                                    </td>
        ...
        <div class="col-xxl-3">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <a href="<?php echo e(URL::asset('/apps-crypto-transactions')); ?>" class="btn btn-soft-info w-100">View All
                            Transactions <i class="ri-arrow-right-line align-bottom"></i></a>
                    </div>
                </div>
            </div>
            <!--end card-->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\Laravel\interactive\resources\views/apps-crypto-wallet.blade.php ENDPATH**/ ?>