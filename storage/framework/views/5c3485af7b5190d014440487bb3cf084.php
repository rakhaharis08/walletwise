                        ...
                        <li>
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-2">
                                    <h6 class="mb-1"><a href="<?php echo e(URL::asset('/pages-profile')); ?>"
                                            class="link-dark">Tonya
                                            Noble</a></h6>
                    ...
                    <div class="text-muted">
                        ...
                        <div class="pt-3 border-top border-top-dashed mt-4">
                            ...
                            <div class="hstack flex-wrap gap-2 fs-15">
                                <div class="badge fw-semibold badge-soft-info">UI/UX</div>
                                <div class="badge fw-semibold badge-soft-info">Dashboard</div>
                                <div class="badge fw-semibold badge-soft-info">Design</div>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div data-simplebar style="height: 508px;" class="px-3 mx-n3 mb-2">
                                <div class="d-flex mb-4">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h5 class="fs-14"><a href="<?php echo e(URL::asset('/pages-profile')); ?>"
                                                class="link-dark">Joseph Parker</a> <small class="text-muted">20
                                        ...
                                        <div class="d-flex mt-4">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <h5 class="fs-14"><a href="<?php echo e(URL::asset('/pages-profile')); ?>"
                                                        class="link-dark">Tonya Noble</a> <small
                                ...
                                <div class="d-flex mb-4">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h5 class="fs-14"><a href="<?php echo e(URL::asset('/pages-profile')); ?>"
                                                class="link-dark">Thomas Taylor</a> <small class="text-muted">24
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h5 class="fs-14"><a href="<?php echo e(URL::asset('/pages-profile')); ?>"
                                                class="link-dark">Tonya Noble</a> <small class="text-muted">26
                                                min ago</small></h5>
                                        ...
                                        <div class="d-flex mt-4">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <h5 class="fs-14"><a href="<?php echo e(URL::asset('/pages-profile')); ?>"
                                                        class="link-dark">Nancy Martino</a> <small
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\Laravel\interactive\resources\views/apps-tasks-details.blade.php ENDPATH**/ ?>