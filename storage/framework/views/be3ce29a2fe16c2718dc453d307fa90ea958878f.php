...
<div class="row">
    <div class="col-xl-6">
        <div class="card">
            ...
            <div class="card-body">
                <div id="basic_candlestick" data-colors='["--vz-info", "--vz-primary"]' class="apex-charts" dir="ltr">
                </div>
            </div><!-- end card-body -->
        </div><!-- end card -->
    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\velzon_Laravel\interactive\resources\views/charts-apex-candlestick.blade.php ENDPATH**/ ?>