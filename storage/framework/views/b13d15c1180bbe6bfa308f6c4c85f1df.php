        ...
        <div class="col-xxl-3 col-lg-6">
            <div class="card pricing-box">
                <div class="card-body bg-light m-2 p-4">
                    ...
                    <div class="mt-3 pt-2">
                        <a href="javascript:void(0);" class="btn btn-primary disabled w-100">Your Current Plan</a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div>
                                ...
                                <div class="mt-4">
                                    <a href="javascript:void(0);"
                                        class="btn btn-soft-info w-100 waves-effect waves-light">Sign up free</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card pricing-box ribbon-box right">
                        <div class="card-body p-4 m-2">
                            ...
                            <div>
                                ...
                                <div class="mt-4">
                                    <a href="javascript:void(0);" class="btn btn-info w-100 waves-effect waves-light">Get
                                        started</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card pricing-box">
                        <div class="card-body p-4 m-2">
                            ...
                            <div>
                                ...
                                <div class="mt-4">
                                    <a href="javascript:void(0);"
                                        class="btn btn-soft-info w-100 waves-effect waves-light">Get started</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\Laravel\interactive\resources\views/pages-pricing.blade.php ENDPATH**/ ?>