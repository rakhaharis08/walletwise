...
<div class="row">
    ...
    <div class="col-xxl-4 col-xl-6">
        <div class="card card-height-100">
            ...
            <div class="card-body p-0">
                <div>
                    <div id="countries_charts" data-colors='["--vz-info", "--vz-info", "--vz-info", "--vz-info", "--vz-primary", "--vz-info", "--vz-info", "--vz-info", "--vz-info", "--vz-info"]' class="apex-charts" dir="ltr"></div>
                </div>
            </div><!-- end card body -->
        </div><!-- end card -->
    </div> <!-- end col-->
...
<div class="row">
    ...
    <div class="col-xxl-4 col-xl-6">
        <div class="card card-height-100">
            ...
            <div class="card-body">
                <div id="portfolio_donut_charts" data-colors='["--vz-primary", "--vz-primary-rgb, 0.80", "--vz-primary-rgb, 0.6", "--vz-primary-rgb, 0.4"]' class="apex-charts" dir="ltr"></div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\velzon_laravel_v2.0\interactive\Admin\resources\views/widgets.blade.php ENDPATH**/ ?>