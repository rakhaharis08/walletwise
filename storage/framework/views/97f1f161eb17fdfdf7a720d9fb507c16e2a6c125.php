    ...
    <div class="col-lg-12">
        <div class="d-lg-flex align-items-center mb-4">
            ...
            <div class="flex-shrink-0 mt-4 mt-lg-0">
                <a href="apps-nft-explore.html" class="btn btn-soft-primary">View All <i class="ri-arrow-right-line align-bottom"></i></a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="card explore-box">
            <div class="card-body">
                ...
                <div class="mt-3">
                    ...
                    <h6 class="fs-16 mb-0"><a href="apps-nft-item-details.html" class="link-dark">Patterns arts & culture</a></h6>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card explore-box">
            <div class="card-body">
                ...
                <div class="mt-3">
                    ...
                    <h6 class="fs-16 mb-0"><a href="apps-nft-item-details.html" class="link-dark">Evolved Reality</a></h6>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card explore-box">
            <div class="card-body">
                ...
                <div class="mt-3">
                    ...
                    <h6 class="fs-16 mb-0"><a href="apps-nft-item-details.html" class="link-dark">Long-tailed macaque</a></h6>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card explore-box">
            <div class="card-body">
                ...
                <div class="mt-3">
                    ...
                    <h6 class="fs-16 mb-0"><a href="apps-nft-item-details.html" class="link-dark">Robotic Body Art</a></h6>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card explore-box">
            <div class="card-body">
                ...
                <div class="mt-3">
                    ...
                    <h6 class="fs-16 mb-0"><a href="apps-nft-item-details.html" class="link-dark">Creative filtered portrait</a></h6>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col">
        <div class="card explore-box card-animate">
            ...
            <div class="card-body">
                ...
                <h5 class="mb-1"><a href="apps-nft-item-details.html" class="link-dark">The Chirstoper</a></h5>
    ...
    <div class="col">
        <div class="card explore-box card-animate">
            ...
            <div class="card-body">
                ...
                <h5 class="mb-1"><a href="apps-nft-item-details.html" class="link-dark">Trendy fashion portraits</a></h5>
    ...
    <div class="col">
        <div class="card explore-box card-animate">
            ...
            <div class="card-body">
                ...
                <h5 class="mb-1"><a href="apps-nft-item-details.html" class="link-dark">Smillevers Crypto</a></h5>
    ...
    <div class="col">
        <div class="card explore-box card-animate">
            ...
            <div class="card-body">
                ...
                <h5 class="mb-1"><a href="apps-nft-item-details.html" class="link-dark">Abstract face painting</a></h5>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\velzon_laravel_v2.0\interactive\Admin\resources\views/apps-nft-marketplace.blade.php ENDPATH**/ ?>