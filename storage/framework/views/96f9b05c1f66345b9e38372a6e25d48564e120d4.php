        ...
        <div class="card" id="company-overview">
            ...
            <div class="card-body">
                ...
                <div class="hstack gap-3">
                    ...
                    <a href="#!" class="btn btn-warning w-100">More View <i class="ri-arrow-right-line align-bottom"></i></a>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\velzon_laravel_v2.0\interactive\Admin\resources\views/apps-job-companies-lists.blade.php ENDPATH**/ ?>