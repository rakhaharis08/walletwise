            ...
            <div class="card card-animate">
                <div class="card-body">
                    ...
                    <h3 class="mb-2">$<span class="counter-value" data-target="74858">0</span><small
                            class="text-muted fs-14">.68k</small></h3>
            ...
            <div class="card card-animate">
                <div class="card-body">
                    ...
                    <h3 class="mb-2">$<span class="counter-value" data-target="74361">0</span><small
                            class="text-muted fs-14">.34k</small></h3>
            ...
            <div class="card card-animate">
                <div class="card-body">
                    ...
                    <h3 class="mb-2">$<span class="counter-value" data-target="97685">0</span><small
                            class="text-muted fs-14">.22k</small></h3>
    ...
    <div class="row align-items-center mb-4 g-3">
        ...
        <div class="col-sm-auto ms-auto">
            <div class="d-flex gap-2">
                ...
                <a href="javascript:void(0);" data-bs-toggle="modal" class="btn btn-primary">Withdraw</a>
            </div>
        </div>
        <!--end col-->
    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\Laravel\interactive\resources\views/apps-crypto-transactions.blade.php ENDPATH**/ ?>