                                ...
                                <div id="newlink">
                                    <div id="1">
                                        <div class="row">
                                            ...
                                            <!--end col-->
                                            <div class="hstack gap-2 justify-content-end">
                                                <a class="btn btn-info" href="javascript:deleteEl(1)">Delete</a>
                                            </div>
                                        </div>
                                        <!--end row-->
                                    </div>
                        ...
                        <div class="tab-pane" id="privacy" role="tabpanel">
                            ...
                            <div>
                                ...
                                <div class="hstack gap-2 mt-3">
                                    <a href="javascript:void(0);" class="btn btn-soft-info">Close &
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\Laravel\interactive\resources\views/pages-profile-settings.blade.php ENDPATH**/ ?>