                            ...
                            <table class="table table-borderless text-center table-nowrap align-middle mb-0">
                                ...
                                <tbody id="products-list">
                                    ...
                                    <tr>
                                        <th scope="row">02</th>
                                        <td class="text-start">
                                            <span class="fw-semibold">Noise NoiseFit Endure Smart Watch</span>
                                    ...
                                    <tr>
                                        <th scope="row">03</th>
                                        <td class="text-start">
                                            <span class="fw-semibold">350 ml Glass Grocery Container</span>
                                    ...
                                    <tr>
                                        <th scope="row">04</th>
                                        <td class="text-start">
                                            <span class="fw-semibold">Fabric Dual Tone Living Room Chair</span>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\Laravel\interactive\resources\views/apps-invoices-details.blade.php ENDPATH**/ ?>