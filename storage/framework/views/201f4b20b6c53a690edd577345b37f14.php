                            ...
                            <div class="text-center mt-sm-5 pt-4">
                                ...
                                <div class="row justify-content-center mb-5">
                                    <div class="col-xl-4 col-lg-8">
                                        <div>
                                            <img src="<?php echo e(URL::asset('assets/images/maintenance.png')); ?>" alt=""
                                                class="img-fluid">
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\Laravel\interactive\resources\views/pages-maintenance.blade.php ENDPATH**/ ?>