                ...
                <div class="d-flex align-items-end justify-content-between mt-4">
                    ...
                    <div class="avatar-sm flex-shrink-0">
                        <span class="avatar-title bg-light rounded fs-3">
                            <i data-feather="file-text" class="text-info icon-dual-info"></i>
                        </span>
                    </div>
                </div>
            </div><!-- end card body -->
    ...
    <div class="col-xl-3 col-md-6">
        ...
        <div class="card card-animate">
            <div class="card-body">
                ...
                <div class="d-flex align-items-end justify-content-between mt-4">
                    <div>
                        <h4 class="fs-22 fw-bold ff-secondary mb-4">$<span class="counter-value" data-target="409.66">0</span>k</h4>
    ...
    <div class="col-xl-3 col-md-6">
        ...
        <div class="card card-animate">
            <div class="card-body">
                ...
                <div class="d-flex align-items-end justify-content-between mt-4">
                    <div>
                        <h4 class="fs-22 fw-bold ff-secondary mb-4">$<span class="counter-value" data-target="136.98">0</span>k</h4>
                        <span class="badge bg-warning me-1">338</span> <span class="text-muted"> Unpaid by
                            clients</span>
                    </div>
                    <div class="avatar-sm flex-shrink-0">
                        <span class="avatar-title bg-light rounded fs-3">
                            <i data-feather="clock" class="text-info icon-dual-info"></i>
                        </span>
                    </div>
                </div>
            </div><!-- end card body -->
    ...
    <div class="col-xl-3 col-md-6">
        ...
        <div class="card card-animate">
            <div class="card-body">
                ...
                <div class="d-flex align-items-end justify-content-between mt-4">
                    <div>
                        <h4 class="fs-22 fw-bold ff-secondary mb-4">$<span class="counter-value" data-target="84.20">0</span>k</h4>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-shrink-0">
                        <div class="d-flex gap-2 flex-wrap">
                            ...
                            <a href="<?php echo e(URL::asset('/apps-invoices-create')); ?>" class="btn btn-primary"><i class="ri-add-line align-bottom me-1"></i> Create Invoice</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="table-responsive table-card">
                        ...
                        <div class="noresult" style="display: none">
                            <div class="text-center">
                                ...
                                <p class="text-muted mb-0">We've searched more than 150+ invoice We did not find any
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\Laravel\interactive\resources\views/apps-invoices-list.blade.php ENDPATH**/ ?>