...
<div class="row">
    <div class="col-xl-6">
        <div class="card">
            ...
            <div class="card-body">
                <div id="column_chart" data-colors='["--vz-gray-300", "--vz-primary", "--vz-info"]' class="apex-charts" dir="ltr"></div>
            </div><!-- end card-body -->
        </div><!-- end card -->
    </div>
    <!-- end col -->
    ...
    <div class="col-xl-6">
        <div class="card">
            ...
            <div class="card-body">
                <div id="column_chart_datalabel" data-colors='["--vz-info"]' class="apex-charts" dir="ltr"></div>
            </div><!-- end card-body -->
        </div><!-- end card -->
    </div>
    <!-- end col -->
...
<div class="row">
    ...
    <div class="col-xl-6">
        <div class="card">
            ...
            <div class="card-body">
                <div id="column_stacked_chart" data-colors='["--vz-primary", "--vz-info", "--vz-gray-300"]' class="apex-charts" dir="ltr"></div>
            </div><!-- end card-body -->
        </div><!-- end card -->
    </div>
    <!-- end col -->
...
<div class="row">
    <div class="col-xl-6">
        <div class="card">
            ...
            <div class="card-body">
                <div id="column_markers" data-colors='["--vz-info", "--vz-primary"]' class="apex-charts" dir="ltr">
                </div>
            </div><!-- end card-body -->
        </div><!-- end card -->
    </div>
...
<div class="row">
    <div class="col-xl-6">
        <div class="card">
            ...
            <div class="card-body">
                <div id="column_nagetive_values" data-colors='["--vz-info", "--vz-primary", "--vz-gray-300"]' class="apex-charts" dir="ltr"></div>
            </div><!-- end card-body -->
        </div><!-- end card -->
    </div>
    <!-- end col -->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\velzon_Laravel\interactive\resources\views/charts-apex-column.blade.php ENDPATH**/ ?>