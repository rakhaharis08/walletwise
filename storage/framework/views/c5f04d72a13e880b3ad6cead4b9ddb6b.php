    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <div id="chart-line" data-colors='["--vz-info"]' class="e-charts"></div>
                </div>
            </div>
            <!-- end card -->
        </div>
    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <div id="chart-step-line" data-colors='["--vz-primary", "--vz-info", "--vz-gray-300"]'
                        class="e-charts"></div>
                </div>
            </div>
            <!-- end card -->
    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <div id="chart-bar" data-colors='["--vz-info"]' class="e-charts"></div>
                </div>
            </div>
            <!-- end card -->
        </div>
    ...
    <div class="row">
        ...
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <div id="chart-candlestick" data-colors='["--vz-primary", "--vz-success"]' class="e-charts"></div>
                </div>
            </div>
            <!-- end card -->
        </div>
    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <div id="chart-sunburst" data-colors='["--vz-priamry", "--vz-info"]' class="e-charts"></div>
                </div>
            </div>
            <!-- end card -->
        </div>
        ...
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <div id="chart-parallel" data-colors='["--vz-info"]' class="e-charts"></div>
                </div>
            </div>
            <!-- end card -->
        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\Laravel\interactive\resources\views/charts-echarts.blade.php ENDPATH**/ ?>