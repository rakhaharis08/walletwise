                    ...
                    <div class="card card-animate">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4">RP.<span class="counter-value" data-target="3000000">0</span>
                                    </h4>
                                </div>
                            </div>
                        </div><!-- end card body -->
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="card card-animate">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4">RP.<span class="counter-value" data-target="5000000">0</span>
                                    </h4>
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="card card-animate">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4">RP.<span class="counter-value" data-target="2000000">0</span>
                                    </h4>
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="card card-animate">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4">RP.<span class="counter-value" data-target="200000">0</span>
                                    </h4>
                            ...
                            <div class="row g-0 text-center">
                                <div class="col-6 col-sm-3">
                                    <div class="p-3 border border-dashed border-start-0">
                                        <h5 class="mb-1">RP.<span class="counter-value" data-target="5">0</span> Juta</h5>
                                ...
                                <div class="col-6 col-sm-3">
                                    <div class="p-3 border border-dashed border-start-0">
                                        <h5 class="mb-1">RP.<span class="counter-value" data-target="2">0</span> Juta</h5>
                                ...
                                <table class="table table-hover table-centered align-middle table-nowrap mb-0">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="fs-14 my-1 fw-normal">RP.300K</h5>
                                                <span class="text-muted">Amount</span>
                                            </td>
                                            <td>
                                                <h5 class="fs-14 my-1 fw-normal">Pakaian</h5>
                                                <span class="text-muted">Category</span>
                                            </td>
                                            <td>
                                                <h5 class="fs-14 my-1 fw-normal">Lunas</h5>
                                        ...
                                        <tr>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h5 class="fs-14 my-1"><a href="<?php echo e(URL::asset('/apps-ecommerce-product-details')); ?>" class="text-reset">Bentwood
                                                                Chair</a></h5>
                                                        <span class="text-muted">2 May 2024</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <h5 class="fs-14 my-1 fw-normal"><span class="badge badge-soft-danger">Belum Lunas</span> </h5>
                                                <span class="text-muted">Status</span>
                                            </td>
                                        </tr>
                                        <tr>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h5 class="fs-14 my-1"><a href="<?php echo e(URL::asset('/apps-ecommerce-product-details')); ?>" class="text-reset">Borosil Paper
                                                                Cup</a></h5>
                                                        <span class="text-muted">3 May 2024</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h5 class="fs-14 my-1"><a href="<?php echo e(URL::asset('/apps-ecommerce-product-details')); ?>" class="text-reset">One Seater
                                                                Sofa</a></h5>
                                                        <span class="text-muted">4 May 2024</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <h5 class="fs-14 my-1 fw-medium"><a href="<?php echo e(URL::asset('/apps-ecommerce-seller-details')); ?>" class="text-reset">Gaji Bulan Januari</a>
                                                        </h5>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <span class="text-muted">Pendapatan Utama</span>
                                            </td>
                                            <td>
                                                <span class="text-muted">RP.10 Juta</span>
                                            </td>
                                        </tr><!-- end -->
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <h5 class="fs-14 my-1 fw-medium"><a href="<?php echo e(URL::asset('/apps-ecommerce-seller-details')); ?>" class="text-reset">Gaji Bulan Februari</a>
                                                        </h5>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <h5 class="fs-14 my-1 fw-medium"><a href="<?php echo e(URL::asset('/apps-ecommerce-seller-details')); ?>" class="text-reset">Gaji Bulan Maret</a>
                                                        </h5>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <h5 class="fs-14 my-1 fw-medium"><a href="<?php echo e(URL::asset('/apps-ecommerce-seller-details')); ?>" class="text-reset">Gaji Bulan April</a>
                                                        </h5>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <h5 class="fs-14 my-1 fw-medium"><a href="<?php echo e(URL::asset('/apps-ecommerce-seller-details')); ?>" class="text-reset">Gaji Bulan Mei</a>
                                                        </h5>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <h5 class="fs-14 my-1 fw-medium"><a href="<?php echo e(URL::asset('/apps-ecommerce-seller-details')); ?>" class="text-reset">Gaji Bulan Juni</a>
                                                        </h5>
                                                    </div>
                                                </div>
                                            </td>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\rakha\Downloads\Laravel\Laravel\interactive\resources\views/index.blade.php ENDPATH**/ ?>