...
<div class="row">
    <div class="col-xl-8">
        <div class="card">
            ...
            <div class="card-body">
                <div id="distributed_treemap" data-colors='["--vz-primary", "--vz-danger", "--vz-secondary", "--vz-success","--vz-warning", "--vz-success"]' class="apex-charts" dir="ltr"></div>
            </div>
        </div>
    </div>
    <!--end col-->
    <div class="col-xl-4">
        <div class="card card-height-100">
            ...
            <div class="card-body">
                <div id="user_device_pie_charts" data-colors='["--vz-secondary", "--vz-danger", "--vz-primary"]' class="apex-charts" dir="ltr"></div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\velzon_laravel_v2.0\interactive\Admin\resources\views/apps-job-statistics.blade.php ENDPATH**/ ?>