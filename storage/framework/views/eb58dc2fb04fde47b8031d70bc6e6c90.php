                    ...
                    <div class="d-flex">
                        <div class="flex-grow-1">
                            ...
                            <h2 class="mb-0">$<span class="counter-value" data-target="243"></span><small
                                    class="text-muted fs-14">.10k</small></h2>
                        </div>
                    ...
                    <div class="d-flex">
                        <div class="flex-grow-1">
                            ...
                            <h2 class="mb-0">$<span class="counter-value" data-target="658"></span><small
                                    class="text-muted fs-14">.00k</small></h2>
                        </div>
                        <div class="flex-shrink-0 avatar-sm">
                    ...
                    <div class="d-flex">
                        <div class="flex-grow-1">
                            ...
                            <h2 class="mb-0">$<span class="counter-value" data-target="104"></span><small
                                    class="text-muted fs-14">.85k</small></h2>
                        </div>
                        <div class="flex-shrink-0 avatar-sm">
                            <div class="avatar-title bg-soft-primary text-primary fs-22 rounded">
                    ...
                    <div class="d-flex">
                        <div class="flex-grow-1">
                            ...
                            <h2 class="mb-0">$<span class="counter-value" data-target="87"></span><small
                                    class="text-muted fs-14">.35k</small></h2>
                        </div>
                        <div class="flex-shrink-0 avatar-sm">
                            <div class="avatar-title bg-soft-info text-infobg-soft-info fs-22 rounded">
                ...
                <div class="card-body p-0">
                    <div class="tab-content text-muted">
                        <div class="tab-pane active" id="cryptoBuy" role="tabpanel">
                            <div class="p-3 bg-soft-info">
                                <div class="float-end ms-2">
                                    <h6 class="text-info mb-0">USD Balance : <span class="text-dark">$12,426.07</span>
                                    </h6>
                                </div>
                            ...
                            <div class="p-3">
                                ...
                                <div class="mt-3 pt-2">
                                    <div class="d-flex mb-2">
                                        <div class="flex-grow-1">
                                            <p class="fs-14 mb-0">Transaction Fees<span
                                    ...
                                    <div class="d-flex mb-2">
                                        <div class="flex-grow-1">
                                            <p class="fs-14 mb-0">Minimum Received<span
                                ...
                                <div class="mt-3 pt-2">
                                    <button type="button" class="btn btn-info w-100">Buy Coin</button>
                                </div>
                            </div>
                        </div>
                        <!--end tab-pane-->
                ...
                <table class="table align-middle table-nowrap" id="customerTable">
                    ...
                    <tbody class="list form-check-all">
                        <tr>
                            ...
                            <td class="valume">
                                <h6 class="text-success mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>1.50%
                                </h6>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td class="market_cap">$314,520,675</td>
                            <td class="valume">
                                <h6 class="text-success mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>0.89%
                                </h6>
                            </td>
                            <td>
                                <button class="btn btn-sm btn-soft-info">Trade Now</button>
                        ...
                        <tr>
                            ...
                            <td class="valume">
                                <h6 class="text-success mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>1.92%
                                </h6>
                            </td>
                            <td>
                                <button class="btn btn-sm btn-soft-info">Trade Now</button>
                        ...
                        <tr>
                            ...
                            <td class="valume">
                                <h6 class="text-success mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>3.96%
                                </h6>
                            </td>
                            <td>
                                <button class="btn btn-sm btn-soft-info">Trade Now</button>
                        ...
                        <tr>
                            ...
                            <td class="market_cap">$156,209,195.18</td>
                            <td class="valume">
                                <h6 class="text-success mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>8.20%
                                </h6>
                            </td>
                            <td>
                                <button class="btn btn-sm btn-soft-info">Trade Now</button>
                        ...
                        <tr>
                            ...
                            <td class="market_cap">$880,387,980.14</td>
                            <td class="valume">
                                <h6 class="text-success mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>1.03%
                                </h6>
                            </td>
                            <td>
                                <button class="btn btn-sm btn-soft-info">Trade Now</button>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\Laravel\interactive\resources\views/apps-crypto-buy-sell.blade.php ENDPATH**/ ?>