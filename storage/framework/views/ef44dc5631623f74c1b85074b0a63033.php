...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row row-cols-xxl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
        <div class="col">
            <div class="card">
                <a class="card-body bg-soft-primary border-0" data-bs-toggle="collapse" href="#leadDiscovered" role="button"
                    aria-expanded="false" aria-controls="leadDiscovered">
                    <h5 class="card-title text-uppercase fw-bold mb-1 fs-15">Lead Discovered</h5>
                ...
                <div class="card mb-1">
                    ...
                    <div class="collapse border-top border-top-dashed" id="leadDiscovered1">
                        ...
                        <div class="card-footer hstack gap-2">
                            <button class="btn btn-primary btn-sm w-100"><i class="ri-phone-line align-bottom me-1"></i>
                                Call</button>
        ...
        <div class="col">
            <div class="card">
                <a class="card-body bg-soft-info border-0" data-bs-toggle="collapse" href="#contactInitiated" role="button"
                    aria-expanded="false" aria-controls="contactInitiated">
                    <h5 class="card-title text-uppercase fw-bold mb-1 fs-15">Contact Initiated</h5>
                ...
                <div class="card mb-1">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#contactInitiated2"
                            ...
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('build/images/brands/github.png')); ?>" alt=""
                                    class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
        ...
        <div class="col">
            <div class="card">
                <a class="card-body bg-soft-primary border-0" data-bs-toggle="collapse" href="#needsIdentified"
                ...
                <div class="card mb-1">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#needsIdentified6"
                            ...
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('build/images/companies/img-6.png')); ?>" alt=""
                                    class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
        ...
        <div class="col">
            <div class="card">
                <a class="card-body bg-soft-info border-0" data-bs-toggle="collapse" href="#meetingArranged" role="button"
                ...
                <div class="card mb-1">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#meetingArranged1"
                            ...
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('build/images/companies/img-5.png')); ?>" alt=""
                                    class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\Laravel\interactive\resources\views/apps-crm-deals.blade.php ENDPATH**/ ?>