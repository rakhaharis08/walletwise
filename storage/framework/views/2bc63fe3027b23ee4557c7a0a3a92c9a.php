                    ...
                    <div class="live-preview">
                        <nav id="navbar-example" class="navbar navbar-dark bg-light px-3">
                            <a class="navbar-brand" href="#">
                                <img src="<?php echo e(URL::asset('assets/images/logo-dark.png')); ?>"
                                    class="card-logo card-logo-dark" alt="logo dark" height="14">
                                <img src="<?php echo e(URL::asset('assets/images/logo-light.png')); ?>"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\Laravel\interactive\resources\views/advance-ui-scrollspy.blade.php ENDPATH**/ ?>