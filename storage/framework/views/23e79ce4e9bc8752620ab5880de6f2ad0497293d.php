        ...
        <div class="card" id="apiKeyList">
            <div class="card-header d-flex align-items-center">
                ...
                <div class="d-flex gap-1 flex-wrap">
                    ...
                    <button type="button" class="btn btn-secondary create-btn" data-bs-toggle="modal" data-bs-target="#api-key-modal"><i class="ri-add-line align-bottom me-1"></i> Add New</button>
                </div>
            </div>
            <div class="card-body">
                <div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\velzon_laravel_v2.0\interactive\Admin\resources\views/apps-api-key.blade.php ENDPATH**/ ?>