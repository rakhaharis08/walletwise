                            ...
                            <div class="tab-pane fade" id="pills-finish" role="tabpanel"
                                ...
                                <div class="text-center py-5">
                                    ...
                                    <h3 class="fw-semibold">Order ID: <a
                                            href="<?php echo e(URL::asset('/apps-ecommerce-order-details')); ?>"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\Laravel\interactive\resources\views/apps-ecommerce-checkout.blade.php ENDPATH**/ ?>