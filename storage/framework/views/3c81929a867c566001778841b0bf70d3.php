                ...
                <div class="row g-4 align-items-center">
                    ...
                    <div class="col-sm-auto">
                        <div class="d-flex flex-wrap align-items-start gap-2">
                            ...
                            <button type="button" class="btn btn-secondary add-btn" data-bs-toggle="modal" id="create-btn" data-bs-target="#showModal"><i class="ri-add-line align-bottom me-1"></i> Add
                                Customer</button>
                            <button type="button" class="btn btn-primary"><i class="ri-file-download-line align-bottom me-1"></i>
                                Import</button>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\Laravel\interactive\resources\views/apps-ecommerce-customers.blade.php ENDPATH**/ ?>